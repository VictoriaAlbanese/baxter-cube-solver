...
static vector<Face> make_test_face_vector1() 
{
	vector<Face> faces;
...
static vector<Face> make_test_face_vector1_front_cw() 
{
	vector<Face> faces;
	vector< vector<int> > face_color_matrix;
	vector<int> temp_row1;
...
static vector<Face> make_test_face_vector1_front_ccw() 
{
	vector<Face> faces;
	vector< vector<int> > face_color_matrix;
	vector<int> temp_row1;
...
static vector<Face> make_test_face_vector1_back_cw() 
{
	vector<Face> faces;
	vector< vector<int> > face_color_matrix;
	vector<int> temp_row1;
...
static vector<Face> make_test_face_vector1_back_ccw() 
{
	vector<Face> faces;
	vector< vector<int> > face_color_matrix;
	vector<int> temp_row1;
...
static vector<Face> make_test_face_vector1_top_cw() 
{
	vector<Face> faces;
	vector< vector<int> > face_color_matrix;
	vector<int> temp_row1;
...
static vector<Face> make_test_face_vector1_top_ccw() 
{
	vector<Face> faces;
	vector< vector<int> > face_color_matrix;
	vector<int> temp_row1;
...
static vector<Face> make_test_face_vector1_bottom_cw() 
{
	vector<Face> faces;
	vector< vector<int> > face_color_matrix;
	vector<int> temp_row1;
...
static vector<Face> make_test_face_vector1_bottom_ccw() 
{
	vector<Face> faces;
	vector< vector<int> > face_color_matrix;
	vector<int> temp_row1;
...
static vector<Face> make_test_face_vector1_left_cw() 
{
	vector<Face> faces;
	vector< vector<int> > face_color_matrix;
	vector<int> temp_row1;
...
static vector<Face> make_test_face_vector1_left_ccw() 
{
	vector<Face> faces;
	vector< vector<int> > face_color_matrix;
	vector<int> temp_row1;
...
static vector<Face> make_test_face_vector1_right_cw() 
{
	vector<Face> faces;
	vector< vector<int> > face_color_matrix;
	vector<int> temp_row1;
...
static vector<Face> make_test_face_vector1_right_ccw() 
{
	vector<Face> faces;
	vector< vector<int> > face_color_matrix;
	vector<int> temp_row1;
